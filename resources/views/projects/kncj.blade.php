...
<section id="about" class="about section">
   <div class="container"  id="overview">
      <div class="">
		 <h1 class="entry-title abt_title2">AXIS KNCZ<br><span class="text-primary abt_title3">Holiday Homes in Darjeeling </span></h1>		 
		 <h3><i>Welcome to India’s first sky bridge resort</i></h3>
		 <br>
		 <p><strong>Party zone in Darjeeling, Outdoor Adventures, and the Best Sun-View Indoor Pool.</strong></p>
	
         <p class="entry-text">   The Axis KNCZ, a true jewel in the crown of Darjeeling. Nestled amidst the serene hills and boasting a breathtaking view of Kanchenjunga's snow-clad peaks, this resort offers an unforgettable experience for holiday homes in Darjeeling.  </p>

		<p> Experience the thrill of a party zone in Darjeeling, where you can immerse yourself in multiple outdoor activities while being surrounded by the legendary beauty of the quiet hills. And for the ultimate relaxation, indulge in our best sun view indoor pool, providing a perfect retreat amid nature's splendor. </p>
		<p>From the lush tea gardens covering the slopes of Darjeeling's hills to the famous Himalayan toy train, the town has much to offer to visitors. Axis KNCZ in Darjeeling offers you the opportunity to enjoy premium resort-living facilities, sun view indoor pool, international design and landscape, and smart hotel suites. </p>
