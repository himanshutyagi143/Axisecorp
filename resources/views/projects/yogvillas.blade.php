...
<div class="project_menu mobile_side">
   ...
   <ul>
      ...
      <li><a href="https://www.youtube.com/embed/eJnXrzHKCZM" data-lity="">Walk Through</a></li>
...
<section id="about" class="about section">
   <div class="container" id="overview">
      <div class="">
		  <h1 class="entry-title abt_title2">Axis Yog Villas <br><span class="text-primary abt_title3">Villa in nearby North of Goa</span></h1>		 
		  <h2 style="font-size: 1.875em; line-height: 1.2;font-weight: 600; color: #3d3d3d; letter-spacing:0;text-transform: inherit;"><i>Your dream luxury vacation home in Goa at Axis Yog Villas your perfect retreat awaits with our stunning 2 BHK villa for sale in Goa.</i></h2>		  
		  <h3><i>The Best Luxury Villas in North of Goa</i></h3>
		  

		 <br>
		<p><strong>Get everything you wished for and more from Axis luxury villas in Goa </strong></p>
         <p class="entry-text">Axis Yog Villas, a paradise of luxurious living in North Goa! Nestled in the picturesque region of Dodamarg, Sindhudurg, our villas offer the perfect blend of tranquility and indulgence. Enjoy the ultimate privacy with villas in North Goa boasting private pools, catering to your every desire for an unforgettable luxury vacation homes in Goa.         
		 </p>
         <p>Drawing inspiration from European clustered-town designs, Axis Yog Villas present a collection of smartly designed villas, seamlessly integrated with nature. Revel in the modern comforts and convenience of these fully serviced villas, crafted to cater to your every need. </p>
         <p> Discover a wide array of luxury villas in North Goa, each with its own distinct flavor - from contemporary chic to effervescent glamour. Whether you seek a 2 BHK villa or a larger villa for sale in North Goa, Axis Yog Villas has it all. Fulfill your dreams of owning a villa in Goa, where every day feels like a blissful retreat. </p>
		 <p>Axis Yog Villas are designed with your convenience in mind from every service offered within these luxury villas in Goa to the project’s close proximity to the new MOPA airport. By owning Axis Yog Villas, luxury villa in Goa, you have the best of all worlds.		 </p>
		 <p>Axis Yog Villas is a RERA certified project designed with the best-in-class standards of premium smart services with centralized concierge desks, intuitive 24/7 housekeeping, and end-to-end property management for your convenience.</p>
		 <p>Stay in the lap of luxury and elegance in these luxury villas in Goa. These fully serviced villa are the epitome of sophistication and luxury the perfect investment to meet your needs when you’re here and when you rent out to travelers.</p>
		 <p>Right from the magical beaches to the warm people, Goa invites you to a lifestyle where the party never ends. Taking inspiration from this amazing culture, we have created a resort-like paradise in one of Goa’s pristine locations. The project size of Axis Yog Villas is a stunning 120 crores which is directed towards creating fully-managed luxury homes for the discerning investor.</p>
		 <p>An investment in one of the best luxury villas in North Goa presents a golden chance to own your dream home, get access to comprehensive shared services of housekeeping and security for our luxury villa in Goa, and rental management services to get the most out of your luxury villas in Goa.</p>
      </div>
   </div>
</section>
