...
<section id="about" class="about section">
   <div class="container" id="overview">
      <div class="">
		 <h1 class="entry-title abt_title2">AXIS BLUES <br><span class="text-primary abt_title3"> Luxury resorts in nearby North of Goa </span></h1>
		 <h2 class="entry-title abt_title3" style="color: #000; font-size: 28px;">Where you can find luxury flats for sale in North Goa and luxurious resorts for sale, all in the heart of Goa's finest offerings.</h2>
         <p class="entry-text">Axis Blues, the epitome of luxury resorts in Goa! Situated in the idyllic North of Goa, Dodamarg,  Sindhudurg, this exquisite property offers a unique opportunity to own apartments in one of the most sought-after  locations in India. Whether you're looking for a property for sale in North Goa or considering investing in luxury  flats or serviced apartments, Axis Blues has it all.
         </p>
         <p>
           Embrace the beauty of nature as you indulge in the Eco-Luxury stay concept, where modern comforts blend seamlessly with the thrill of living amidst lush rainforests. Our resort destination in Goa offers a multiple outdoor activities, ensuring an unforgettable experience for every guest. 
         </p>
         <p>Dreaming of owning a luxury resort? Look no further, as Axis Blues also presents exclusive luxury resorts for sale 
		 in Goa. Don't miss the chance to be a part of this prestigious hospitality venture that celebrates the essence of 
		 opulence and nature's magnificence.          
         </p>
         <p>
            Project is overlooking 6 Acre Lake, where you can enjoy your life with your family & guest, located in the heart of 
			valley, only 35km away as neighborhood of Panaji, the ultimate prestigious area for the resort destination, and 
			features unique physical characteristics that make it truly remarkable. 
         </p>
		 <p>The experience is made flawless by an innovative service concept, informal yet impeccable. The recreational area 
		 and restaurant, accompanied by exclusive function spaces, wants to become the most coveted destination point for nature
		 lovers. </p>
		 <p>Laze around on dew-laced nature &amp; lush green views that melt your heart. Fresh air wake up along with birds and bees,
		 the scenic backdrop mountain, the quaint nature and it’s simple smiling inhabitants welcomes you to revel in a vibrant
		 &amp; harmonious ecosystem with class and high standard service and comfort with contemporary modern comfort, enriched by 
		 designer furniture &amp; materials.</p>
      </div>
   </div>
</section>
   ...
   <div class="container">
	...
	<div class="text-center" style="padding-bottom: 22px"> 
	  <h4 >Construction Update</h4>
	   <h5 style="padding-bottom: 16px">( 1 July 2023 )</h5>
	  <button type="submit" class="btn btn-shadow-2 wow" style="visibility: visible;padding: 1em 2em 1em;">
	  <a class="" style="color: #fff; text-decoration: none;" href="frontend/img/projects/axisblues/updatepdf/Construction-Update-1July2023.pdf" data-lity>Download Now</a>
	  </button>
	  </div>
      <div class="tab-pane video_gallery status">
         <div class="projects-carousel js-projects-carousel ">
		  ...
		  <div class="project">
            ...
            <div class="project">
               <div class="img_holder">
                  <a href='https://www.youtube.com/watch?v=pkwibtuj7oI&ab_channel=AxisE-corp'
                     data-lity><img
                     src="{{ URL::asset('frontend/img/projects/axisblues/gallery/projectstatus/blues-gallery-video1.jpg')}}" alt="blues-gallery-video1.jpg"></a>
               </div>
               <p>December 2019</p>
