        ...
        <div class="section-content">
            <div class="row-base row">
                ...
                <div class="col-base  col-md-4">
                    <form class="js-ajax-form contact_form" id="contactForm" >
    ...
    <div class="container">
        <div class="row-base row">
            ...
            <div class="text-right-md col-base col-md-3">
                © 2024 Axis Ecorp | All Rights Reserved.
            </div>
        </div>
    </div>
...
<!--<div class="footer_whatsup"><a href="https://api.whatsapp.com/send?phone=918070004400" target="blank"><img src="{{ URL::asset('frontend/img/others/wtsup-icon.png')}}" alt="whats up"></a></div>-->
