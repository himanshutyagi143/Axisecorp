      ...
      <div class="row">
         <div class="col-lg-2 col-sm-2 col-xs-2">
            <div class="header_btn">
               ...
               @else
               <h1 class="logo"><img src="/fronted/img/logo1.png"  /></h1>
               @endif
            </div>
         </div>
         <div class="col-lg-10 col-sm-10 col-xs-10 nav_panel">
            <nav class="overlay-menu ">
               ...
               @if(Request::segment(1) != "veryifyotp_for_booking" && Request::segment(1) != "veryifyUnit_for_booking")
                  ...
                  {{--<li @if(Request::segment(1)=='axisblues') class="active" @endif><a href="/axisblues">Project </a></li>--}}

                  <li @if(Request::segment(1)=='axisblues') class="dropdown active" @else class="dropdown" @endif>
                     <a class="dropdown-toggle" data-toggle="dropdown" href="#">Project<span class="fa fa-angle-down arrow-down"></span></a>
                     <ul class="dropdown-menu">
                        <li><a href="/axisblues">Axisblues</a></li>
                        <li><a href="/yogvillas" >Yogvillas</a></li>
                     </ul>
                  </li>
