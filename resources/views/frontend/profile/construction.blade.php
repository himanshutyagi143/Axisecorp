                ...
                <div id="demo-2" data-zs-src='["/fronted/images/2.jpg"]' data-zs-overlay="dots">
                    <div class="demo-inner-content">
                        <div class="baner-info">
                             <h3>Construction<span> Updates</span></h3>
                        </div>	
                    </div>
                </div>
                <!--//Slider-->
                                                ...
                                                <ul>
                                                    ...
                                                    <li class="clearfix">
                                                        ...
                                                        <div class="sub_nameAddress" style="height: auto;">
                                                            <span id="ctl00_ContentPlaceHolder1_lblmaddress">529-C REGENT SHIPRA SUN CITY INDIRAPURAM </span>
                                                        </div>
                                                    </li>
                                                    <li class="clearfix">
                                            ...
                                            <div class="fild_set">
                                                <ul>
                                                    ...
                                                    <li class="clearfix">
                                                        ...
                                                        <div class="sub_name">
                                                            <span id="ctl00_ContentPlaceHolder1_lblSLandline">-</span>
                                                        </div>
                                                    </li>
                                                    <li class="clearfix">
                                                        <div class="name">
