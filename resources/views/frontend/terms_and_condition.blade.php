...
@section('term-and-condition-current-menu', 'current-menu-item')
                    ...
                    <div id="breadcrumbs">
                        <div class="breadcrumbs-inner">
                            <div class="breadcrumb-trail">
                                ...
                                <span class="sep">|</span>
                                <span class="trail-end">Terms & Condition</span>
                            </div>
                        </div>
                    </div>
                           ...
                           <!-- CONTACT -->
                            <div class="row-contact">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="themesflat-spacer clearfix" data-desktop="61" data-mobile="20" data-smobile="20"></div>
                                        </div><!-- /.col-md-12 -->
                                    </div><!-- /.row -->
                                    <div class="row">
                                        <!-- /.col-md-6 -->
...
<h2 class="heading">Terms and conditions forming part of the Application Form for Registration of Unit</h2>
...
<li>That the Applicant(s) on being Non-Resident Indian/ Foreign National Buyer shall be responsible for the fulƒOllment of it¡¦s Obligations in the Foreign Exchange Management Act, 1999, instruction/directions issued by Reserve Bank of India and other prevailing applicable laws, rules notiƒOcations including that for the remittance of payment(s) and obtaining permission as prescribed by law for acquisition of immovable property in India.</li>
...
<li>Company reserves the right to change any design layout area specication/ facilities and amenities of the proposed project without prior notice and information. The Brochure/ map is for illustration purpose only and it cannot be treated as legal document.</li>
...
<li>The company has sole right to incorporate more terms and conditions for smooth functioning , construction of the project or to effectuate any statutory rules and regulations. Applicants shall follow all the rules and regulations related to Registrar OfƒOce for timely execution of BBA / ATS, he shall be sole responsible for any delay in execution of BBA / ATS and relevant penalty if any.</li>
...
<li>he payment shall be accepted only through A/c payee Cheque, Bank Draft, Bank Cheque or through NEFT/ RTGS drawn in favour of <strong>M/s Eejak Holdings Pvt. Ltd.</strong></li>
...
<li>Applicant have to maintain all correspondence / Communication to Yog Villas, <strong>M/s Eejak Holdings Pvt. Ltd.</strong> , 305, Gera Imperium Grand, Patto Center, Panjim, Goa-403001 or email at "care@axisblues.com" only.</li>
