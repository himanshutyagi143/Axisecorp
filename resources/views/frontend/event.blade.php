...
@include('frontend.profile.upper_link')
	...
	<div class="contact" id="contact" style="padding-top:120px;">
		<div class="container">
		<div class="w3ls-agile-left mb40">
                    <h3 class="w3l_head">Where does it come from</h3>
                    <p class="w3ls_head_para">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                </div>
