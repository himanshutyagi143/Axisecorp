         ...
         <div id="inner-content" class="inner-content-wrap">
            <article class="hentry data-effect">
               <div class="post-media data-effect-item has-effect-icon offset-v-25 offset-h-24 clerafix">
                  ...
                  @if($is_slug==1) <img src="{{$posts->image}}" alt=""
                     class="img-responsive center-block">  @endif
               ...
               <div class="post-content-wrap clearfix">
                  ...
                  <div class="post-meta">
                     <div class="post-meta-content">
                        <div class="post-meta-content-inner">
                           ...
                           @if($posts->author)<span class="post-by-author item"><span class="inner"><a
                              href="#">By: {{$posts->author}}</a></span></span>@endif
                  ...
                  <div class="post-content post-excerpt margin-bottom-43">
                     @if($is_slug!=1) 
                     <p
                        class="line-height-27 letter-spacing-005">{{str_limit(strip_tags($posts->content),400,'...')}}</p>
                     @endif
                     @if($is_slug==1)
                     <div class="long_text">{!!$posts->content!!}</div>
                     @endif
                  </div>
                  <div class="post-socials detail_sociail">
                     <a style="background:#25D366"
                        href="https://api.whatsapp.com/send?text={{urlencode(url('/blogs/'.$posts->slug.'/'))}}"
                        data-action="share/whatsapp/share" target="_blank"><span class="fa fa-whatsapp"></span></a>
                     <div class="" data-href="{{url('/blogs/'.$posts->slug)}}"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={{urlencode(url('/blogs/'.$posts->slug.'/'))}}&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore"><span
                        class="fa fa-facebook-square"></span></a></div>
                     <a href="https://api.addthis.com/oexchange/0.8/forward/twitter/offer?url={{urlencode(url('/blogs/'.$posts->slug.'/'))}}"
                        class="twitter" target="_blank"><span class="fa fa-twitter"></span></a>
                     <a href="https://api.addthis.com/oexchange/0.8/forward/linkedin/offer?url={{urlencode(url('/blogs/'.$posts->slug.'/'))}}"
                        class="linkedin" target="_blank"><span class="fa fa-linkedin-square"></span></a>
                   {{--  <a href="https://api.addthis.com/oexchange/0.8/forward/instagram/offer?url={{urlencode(url('/blogs/'.$posts->slug.'/'))}}"
                        class="pinterest" target="_blank"><span class="fa fa-instagram"></span></a> --}}
                  </div>
