                                                        ...
                                                        <ul>
                                                            <li class="clearfix">
                                                                <div class="inner">
                                                                    ...
                                                                    <span class="text">305,Gera Imperium Grand, Patto Center, Panjim, Goa - 403001 </span>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="clearfix">
                                                                <div class="inner">
                                                                    ...
                                                                    <span class="text">CALL US : <a
                                                                                href="tel:+91 8070004400">+91 8070004400</a></span>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="clearfix">
                                                                <div class="inner">
                                                                    ...
                                                                    <span class="text">EMAIL : <a
                                                                                href="mailto:info@axisecorp.com">info@axisecorp
                                                                            .com</a></span>
                                                                </div>
                                                            </li>
                                                        </ul>
                                                    ...
                                                    <div class="item-content">
                                                        <ul>
                                                            <li class="clearfix">
                                                                <div class="inner">
                                                                    <span class="fa fa-map-marker"></span>
                                                                    <span class="text">H/134, Sector 63, Noida - 201301 </span>
                                                                </div>
                                                            </li>
                                                    ...
                                                    <div class="item-content">
                                                        <ul>
                                                            <li class="clearfix">
                                                                <div class="inner">
                                                                    <span class="fa fa-map-marker"></span>
                                                                    <span class="text">117/N/88, Kakadeo Kanpur - 208025 </span>
                                                                </div>
                                                            </li>
