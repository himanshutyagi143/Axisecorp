...
<div class="banner corporate_banner">
<div class="col-md-12">
<h1 class="about_title">Our Industries </h1>
<span>
                        ...
                        <div class="services" id="services">
                           ...
                           <div class="row">
                              <div class="col-md-3  col-sm-3">
                                 <div class="Highlight">
                                    <img class="font-icons" src="fronted/img/rera.jpg" alt="Rera logo">
                                    <b>Unit Registry </b>
                                 </div>
                              </div>
                              <div class="col-md-3 col-sm-3">
                                 <div class="Highlight">
                                    <img class="font-icons" src="fronted/img/planning.png" alt="Image 2">
                                    <b>Commercial Approved </b>
                                 </div>
                              </div>
                              <div class="col-md-3 col-sm-3">
                                 <div class="Highlight">
                                    <img class="font-icons" src="fronted/img/tax.png" alt="Tax image 2">
                                    <b>CLP </b>
                                 </div>
                              </div>
                              <div class="col-md-3 col-sm-3">
                                 <div class="Highlight">
                                    <img class="font-icons" src="fronted/img/map.png" alt="Map ">
                                    <b>Smart Hotel Suites</b>
                                 </div>
                              </div>
                              <div class="col-md-3 col-sm-3">
                                 <div class="Highlight">
                                    <img class="font-icons" src="fronted/img/building.png" alt="Building ">
                                    <b>Ground + 3 </b>
                                 </div>
                              </div>
                              <div class="col-md-3 col-sm-3">
                                 <div class="Highlight">
                                    <img class="font-icons" src="fronted/img/award.png" alt="Award">
                                    <b>100% Vastu Complaince </b>
                                 </div>
                              </div>
                              <div class="col-md-3 col-sm-3">
                                 <div class="Highlight">
                                    <img class="font-icons" src="fronted/img/apartment.png" alt="Apartment 1">
                                    <b>Rental + stay </b>
                                 </div>
                              </div>
                              <div class="col-md-3 col-sm-3">
                                 <div class="Highlight">
                                    <img class="font-icons" src="fronted/img/kitchen.png" alt="Kitchen ">
                                    <b>Fully Funrished </b>
                                 </div>
                              </div>
                           </div>
