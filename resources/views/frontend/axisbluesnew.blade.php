    ...
    <div id="wrapper">
        ...
        <div id="main-content">
            ...
            <div class="scroll_section">
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="price-list">
                                    <div class="row">
                                        ...
                                        <a class="example-image-link"
                                           href="{{asset('fronted/img/nature/Axisblues_new_pricelist.jpg')}}"
                                           data-lightbox="example-1">
                                            <img class="example-image"
                                                 src="{{asset('fronted/img/nature/Axisblues_new_pricelist.jpg')}}"
                                                 alt="image-1"/></a>
                                            ...
                                            <div class="owl-carousel">
                                                <div class="item">
                                                    <div class="video_outer">
                                                        ...
                                                        <div class="video_share" data-href="{{url('/axisblues/videodetail/construction_dec20')}}">
                                                            <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={{urlencode(url('/axisblues/videodetail/construction_dec20'))}}&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore"><i class="fa fa-facebook"></i></a>
                                                        </div>
                                                ...
                                                <div class="item">
                                                    <div class="video_outer">
                                                        ...
                                                        <div class="video_share" data-href="{{url('/axisblues/videodetail/construction_oct20')}}">
                                                            <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={{urlencode(url('/axisblues/videodetail/construction_oct20'))}}&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore"><i class="fa fa-facebook"></i></a>
                                                        </div>
                                                ...
                                                <div class="item">
                                                    <div class="video_outer">
                                                        ...
                                                        <div class="video_share" data-href="{{url('/axisblues/videodetail/construction_july20')}}">
                                                            <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={{urlencode(url('/axisblues/videodetail/construction_july20'))}}&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore"><i class="fa fa-facebook"></i></a>
                                                        </div>
                                                ...
                                                <div class="item">
                                                    <div class="video_outer">
                                                        ...
                                                        <div class="video_share" data-href="{{url('/axisblues/videodetail/construction_feb20')}}">
                                                            <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={{urlencode(url('/axisblues/videodetail/construction_feb20'))}}&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore"><i class="fa fa-facebook"></i></a>
                                                        </div>
                                                ...
                                                <div class="item">
                                                    <div class="video_outer">
                                                        ...
                                                        <div class="video_share" data-href="{{url('/axisblues/videodetail/construction_jan20')}}">
                                                            <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={{urlencode(url('/axisblues/videodetail/construction_jan20'))}}&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore"><i class="fa fa-facebook"></i></a>
                                                        </div>
                                                        <h3>January 2020</h3>
                                                        <video width="100%" controls>
                                                ...
                                                <div class="item">
                                                    <div class="video_outer">
                                                        ...
                                                        <div class="video_share" data-href="{{url('/axisblues/videodetail/construction_dec19')}}">
                                                            <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={{urlencode(url('/axisblues/videodetail/construction_dec19'))}}&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore"><i class="fa fa-facebook"></i></a>
                                                        </div>
                                                        <h3>December 2019</h3>
                                                        <video width="100%" controls>
                ...
                <span id="certificates"><br><br><br><br></span>
                <section id="">
                    <div class="title title-center section_title">
                        <h2>MAHARERA Certificates </h2>
                    </div>
                    <div class="container">
                        <div class="tab-line-bottom">
                            <ul class="nav nav-tabs" role="tablist" id="rera">
                                <li class="nav-item" role="presentation">
                                    <a href="#rera_image-1" id="rera1" class="active" onclick="planCick('rera1')"
                                       class="active" aria-controls="features-4" role="tab" data-toggle="tab">
                                        Towers A,D,G
                                    </a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a href="#rera_image-2" id="rera2" onclick="planCick('rera2')"
                                ...
                                <li class="nav-item" role="presentation">
                                    <a href="#rera_image-3" id="rera3" onclick="planCick('rera3')"
                                       aria-controls="text-4" role="tab" data-toggle="tab">
                                        Towers C,F,I,J
                                    </a>
                                </li>
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade in active" id="rera_image-1">
                                    <div class="row">

                                        <a class="example-image-link"
                                           href="{{asset('fronted/img/nature/RERA1.jpg')}}"
                                           data-lightbox="example-1">
                                            <img class="example-image"
                                                 src="{{asset('fronted/img/nature/RERA1.jpg')}}"
                                                 alt="image-1"/></a>

                                    </div>
                                </div>
                                <div role="tabpanel" class="tab-pane fade" id="rera_image-2">
                                    <div class="row">


                                        <a class="example-image-link"
                                           href="{{asset('fronted/img/nature/RERA2.jpg')}}"
                                           data-lightbox="example-1">
                                            <img class="example-image"
                                                 src="{{asset('fronted/img/nature/RERA2.jpg')}}"
                                                 alt="image-1"/></a>


                                    </div>
                                </div>
                                <div role="tabpanel" class="tab-pane fade" id="rera_image-3">
                                    <div class="row">


                                        <a class="example-image-link"
                                           href="{{asset('fronted/img/nature/RERA3.jpg')}}"
                                           data-lightbox="example-1">
                                            <img class="example-image"
                                                 src="{{asset('fronted/img/nature/RERA3.jpg')}}"
                                                 alt="image-1"/></a>
                                    </div>
                                </div>
                            </div>
