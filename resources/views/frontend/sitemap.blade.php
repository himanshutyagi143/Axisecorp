                     ...
                     <div class="w3l-grids-about">
                        ...
                        <div class="services" id="services">
                           ...
                           <div class="row">
                              ...
                              <div class="col-md-3 col-sm-3">
                                 <div class="Highlight">
                                    <img class="font-icons" src="fronted/img/planning.png" alt="Image 4">
                                    <b>Commercial Approved </b>
                                 </div>
                              </div>
                              <div class="col-md-3 col-sm-3">
                                 <div class="Highlight">
                                    <img class="font-icons" src="fronted/img/tax.png" alt="Tax image 4">
                                    <b>CLP </b>
                                 </div>
                              </div>
                              <div class="col-md-3 col-sm-3">
                              ...
                              <div class="col-md-3 col-sm-3">
                                 <div class="Highlight">
                                    <img class="font-icons" src="fronted/img/apartment.png" alt="Apartment 3">
                                    <b>Rental + stay </b>
                                 </div>
                              </div>
                              <div class="col-md-3 col-sm-3">
