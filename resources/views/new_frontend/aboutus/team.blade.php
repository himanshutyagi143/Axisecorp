                 ...
                 <?php /* ?>  <div class="col-sm-12 col-md-12 wow fadeInUp axisfadeup">
					...
					<li>
					    ...
					    <div class="col-sm-12 col-md-12 wow fadeInUp axisfadeup">
                            <div class="service-item">
                                <div class="image_holder col-sm-4 col-md-3"><img alt="Abhishek Sharma"
                                  src="{{ URL::asset('frontend/img/team/team-21.jpg') }}">
                                </div>
                                <div class="col-sm-8 col-md-9">
                                    <h4>Deepa Saxena</h4>
									<div class="recent-post-time">GM Corporate Governance</div>
                                   <p>Mrs Deepa Saxena, a science graduate and has more than 20 years of experience in the field of education and electronics distribution. She has over a decade of experience in doing administrative work and she specialises in managing highly productive teams.Her hobbies include singing and reading. She has excellent knowledge of "Vaastu Principles" and have been providing consulting services under the brand name "Vastu Veda" for over two decades and has a long list of happy clients.</p>
                                </div>
                            </div>
                        </div>
					</li>
					...
					<?php /* ?>
					 <li>
                        ...
                        <div class="col-sm-12 col-md-12 wow fadeInUp axisfadeup">
                            <div class="service-item">
                                <div class="image_holder col-sm-4 col-md-3"><img alt="Shruti Meena"
                                  src="{{ URL::asset('frontend/img/team/team-16.jpg') }}">
                                </div>
                                <div class="col-sm-8 col-md-9">
                                    <h4>Shruti Meena </h4>
									<div class="recent-post-time">VP - Business Development</div>
                                    <!--<div class="recent-post-time">GM Corporate Communication</div> -->
                                    <p>A Seasoned Professional, with hands on expertise in Business development, Shruti finds business development exciting and inspirational. Her experience of over 11 years across real estate and allied businesses brings diverse skills on the table. Her keen approach to problem solving and team motivation is incredibly on point. Combination of an Engineer and a management graduate, she has learnt to be analytical and apply the learnings in real life as well. In her free time she like to explore business ideas and travel. </p>
                                    {{--<div class="socials">
                                    <a href="#"><span class="fa fa-facebook-square"></span></a>
                                    <a href="#"><span class="fa fa-twitter"></span></a>
                                    <a href="#"><span class="fa fa-linkedin-square"></span></a>
                        ...
                        <div class="col-sm-12 col-md-12 wow fadeInUp axisfadeup">
                            <div class="service-item">
                                ...
                                <div class="col-sm-8 col-md-9">
                                    ...
                                    <div class="recent-post-time">Dy. Vice President BD</div>
