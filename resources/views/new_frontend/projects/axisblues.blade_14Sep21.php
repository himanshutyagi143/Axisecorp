...
<section id="about" class="about section">
   <div class="container" id="overview">
      <div class="">
         ...
         <p class="entry-text">Axis Blues is planned for prime hospitality & rainforest resort
            destination, its aim is to provide Eco-Luxury stay which preserves the excitement of nature living with
            modern comfort.
         </p>
         <p>
            Project is overlooking 6 Acre Lake, where you can enjoy your life with your family & guest,
            located in the heart of valley, only 35km away as neighbourhood of Panaji, the ultimate
            prestigious area for the resort destination, and features unique physical characteristics
            that make it truly remarkable.
         </p>
         <p>The experience is made flawless by an innovative service concept, informal yet impeccable.
            The recreational area and restaurant, accompanied by exclusive function spaces, wants to
            become the most coveted destination point for nature lovers.
         </p>
         <p>
            Laze around on dew-laced nature & lush green views that melt your heart. Fresh air wake up
            along with birds and bees, the scenic backdrop mountain, the quaint nature & it’s simple
            smiling inhabitants welcomes you to revel in a vibrant & harmonious ecosystem with class and
            high standard service and comfort with contemporary modern comfort, enriched by designer
            furniture & materials.
         </p>
      </div>
   </div>
