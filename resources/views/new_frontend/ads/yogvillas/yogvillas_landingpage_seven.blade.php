...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/css/normalize.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/css/main.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/css/solido.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/css/isotope.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/css/responsive.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/css/vegas/jquery.vegas.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/css/popup/magnific-popup.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/js/superslides-0.6.2/dist/stylesheets/superslides.css') }}">

    <!-- Colors Style -->
    <link rel="stylesheet" href="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/css/color/green.css') }}">

    <script src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/js/vendor/modernizr-2.6.2.min.js') }}"></script>
    <!--<script src="http://fast.fonts.net/jsapi/3dca1e78-579f-4502-8da9-3eb91453e0dc.js"></script>-->

    <script src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/webshim/1.14.5/polyfiller.js') }}"></script>
...
<div id="mask">
    <div class="loader">
        <img src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/img/loader.gif') }}" alt='loading'>
    </div>
</div>
<div class="fixed-logo" id="logo"><a href="#" title="Writer's Village"><img src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/img/logo.png') }}" class="wv-logo"></a>
</div>
<div class="color-picker" style="display:none;">
    ...
    <div class="pwrapper">
        ...
        <div class="light-version"><img title="" alt='img' src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/img/light.jpg') }}"></div>
        <div class="dark-version"><img title="" alt='img' src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/img/dark.jpg') }}"></div>
...
<div class="fixedContainer" id="contact_us"><a href="#" title="Register Your Expression of Interest here"><img
                src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/img/eoi-icon-02.png') }}" class="register"></a></div>
...
<div id="slides-1">
    ...
    <div class="slides-container">
        <img src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/img/slider/slider05.jpg') }}" alt="Writer's Village">
        <img src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/img/slider/slider05.jpg') }}" alt="Writer's Village">
        <img src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/img/slider/slider05.jpg') }}" alt="Writer's Village">
    </div>
</div>
...
<div id="logx"></div>
<header class="header">
    <div class="logo" style="padding-top:5px;display:none;"><a href="#home1"><img src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/img/logo.png') }}"
                                                                                  class="wv-logo"></a></div>
...
<article id="concept" class="content light menu-top">
    ...
    <div class="title two">
        ...
        <p style="text-align:justify;">In our fast paced life, it is easy to lose track of the time, to forget the
            things that matter and be absorbed in what is in front of us. However, this pandemic has made everyone to
...
<article id="cottage" class="content dark menu-top">
    <div class="full">
        ...
        <div class="spacer"></div>
        <br> <br>
        <img src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/img/cottage.jpg') }}" alt="small house" style="width:100%;height:auto;">
        ...
        <div id="ca-container" class="ca-container">
            ...
            <div class="title two">
                ...
                <div class="key_elements">
                    <div class="left">
                        <div class="image_holder">
                            <img src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/img/lifestyle/thumb/micro-farm.jpg') }}" alt="#">
                        </div>
                    </div>
                    <div class="right">
                ...
                <div class="key_elements">
                    ...
                    <div class="right">
                        <div class="image_holder">
                            <img src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/img/lifestyle/thumb/bonfire.jpg') }}" alt="#">
                        </div>
                    </div>
                    <div class="clear"></div>
                </div>
                ...
                <div class="key_elements">
                    <div class="left">
                        <div class="image_holder">
                            <img src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/img/lifestyle/thumb/yoga.jpg') }}" alt="#">
                        </div>
                    </div>
                    <div class="right">
                        <div class="cont">
...
<article id="permaculture" class="content dark">
    <div class="full">
        ...
        <div class="title two" style="text-align:justify;">
            ...
            <img src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/img/permaculture.png') }}" alt="Permaculture"
...
<div id="maps">
    <div class="title two f-bottom">
        ...
        <div class="map_one"><img src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/img/yogvills-map.jpg') }}"></div>
        <div class="map_two">
            <h2>Connectivity</h2>
            <p></p>
        ...
        <div class="location_advatage">
            ...
            <div class="detail">
                ...
                <img src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/img/road.jpg') }}">
            </div>
            ...
            <div class="detail">
                ...
                <img src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/img/rail.jpg') }}">
            </div>
            ...
            <div class="detail">
                ...
                <img src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/img/sea.jpg') }}">
            </div>
...
<footer id="contact" class="footer light">
    <div class="footer-container">
        ...
        <div class="foot-third hideme dontHide">
            ...
            <div class="f-data adress"><img src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/img/adress-ico.png') }}" alt='img'> Adress:
            ...
            <div class="f-data phone"><img src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/img/phone-ico.png') }}" alt='img'> Phone:
                <aside style="margin-left:87px;margin-top:-30px;"><span>+91 807-000-4400</span></aside>
            </div>
            <div class="f-data e-mail"><img src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/img/mail-ico.png') }}" alt='img'> Email: <span><a
        ...
        <div class="foot-third hideme dontHide">
            ...
            <div class="f-data hour-1"><img src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/img/hours-ico.png') }}" alt='img'> Mon. - Sat. <span>10 am to 6 pm</span>
            </div>
            <!-- <div class="f-data hour-2"><img src="img/hours-ico.png" alt='img'> Sat. <span>8am to 11am</span></div> -->
            <div class="f-data hour-3"><img src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/img/hours-ico.png') }}" alt='img'> Sun. <span>Closed</span></div>
        </div>
        <div class="foot-third hideme dontHide">
            ...
            <form method="post" id="contact-form" class="peThemeContactForm js-ajax-form contact_form">
                <input type="hidden" name="srd_id" id="srd_id" value="60fc04b6a6bbc95306a3c82f">
                ...
                <div id="personal" class="bay form-horizontal">
                    ...
                    <div class="control-group"><!--phone field-->
                        <div class="controls">
                            ...
                            <input type="hidden" name="page_reference" value="yogvillas_landingpage_seven">
                        </div>
                    </div>
                    ...
                    <div class="control-group"><!--message field-->
                        <div class="controls">
                            <textarea name="txtMsg" id="textmsg" placeholder="Message" rows="12" class="span9">Message</textarea>
                        </div>
                    </div>
...
<script src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/ajax/libs/jquery/1.9.1/jquery.min.js') }}"></script>
<script>window.jQuery || document.write('<script src="js/vendor/jquery-1.9.1.min.js"><\/script>')</script>
<script src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/ajax/libs/jqueryui/1.9.2/jquery-ui.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/js/jquery.carouFredSel-6.2.1-packed.js') }}"></script>
<script src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/js/jquery.smoothwheel.js') }}"></script>
<script src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/js/main.js') }}"></script>
<script src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/js/jquery.inview.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/js/jquery.sticky.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/js/caroussel/jquery.easing.1.3.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/js/portfolio.js') }}"></script>
<!--<script type="text/javascript" src="js/vegas/jquery.vegas.js"></script>-->
<script src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/js/superslides-0.6.2/dist/jquery.superslides.js') }}" type="text/javascript" charset="utf-8"></script>

<script type="text/javascript" src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/js/jquery.hoverdir.js') }}"></script>
<script src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/js/jquery.nav.js') }}"></script>
<script src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/js/popup/jquery.magnific-popup.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/js/caroussel/jquery.contentcarousel.js') }}"></script>
<script src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/js/jquery.isotope.min.js') }}"></script>
<script src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/js/plugins.js') }}"></script>
<!--<script type="text/javascript" src="js/vegas/vegas_slider.js"></script>-->
<script src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/js/jquery.validate.js') }}"></script>
<script src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/js/jquery.form.js') }}"></script>
<script src="{{ URL::asset('frontend/yogvillas/yogvillas_landingpage_seven/js/test.js') }}"></script>
...
<div id="contact_form" class="white-popup mfp-hide">
    ...
    <form method="post" id="contact-popup" class="peThemeContactForm js-ajax-form contact_form">
        ...
        <div id="personal" class="bay form-horizontal">
            <div class="control-group"><!--name field-->
                <div class="controls">
                    <input class="span9" required type="text" name="txtName" placeholder="Name *" data-fieldid="0"
                           title="Name" onclick="if(this.value=='Your Name') this.value=''"
                           onblur="if(this.value=='') this.value='Your Name'">
                </div>
            </div>
            <div class="control-group"><!--email field-->
                <div class="controls">
                    <input class="span9" name="txtEmail" required placeholder="Email *" data-fieldid="1"
                           title="Your Email" onclick="if(this.value=='Your Email') this.value=''"
            ...
            <div class="control-group"><!--phone field-->
                <div class="controls">
                    <input class="span9" id="telephone2" name="txtPhone" required placeholder="phone *" data-fieldid="2"
                           title="Phone Number"
                           onclick="if(this.value=='Your Phone Number') this.value=''"
                           onblur="if(this.value=='') this.value='Your Phone Number'">
                    <input type="hidden" name="page_reference" value="yogvillas_landingpage_seven">
                </div>
            </div>
            {{--<div class="control-group"><!--occupation field-->
                <div class="controls">
                    <input class="span9" required="true" type="text" name="occupation" data="occupation"
                           data-fieldid="3" value="Your Occupation / line of work"
                           title="Your Occupation / line of work"
                           onclick="if(this.value=='Your Occupation / line of work') this.value=''"
                           onblur="if(this.value=='') this.value='Your Occupation / line of work'">
                </div>
            </div>--}}
            <div class="control-group"><!--message field-->
                <div class="controls">
                    <textarea name="txtMsg" id="textmsg" placeholder="Message" rows="12" class="span9" data-fieldid="6" style="height:50px;"
                              onclick="if(this.value=='Message') this.value=''">Message</textarea>
                </div>
            </div>
            <div class="control-group">
                <div class="controls send-btn">
        ...
        <div class="notifications">
            <div id="contactFormSent" class="formSent-popup alert alert-success">
                <strong>Your Message Has Been Sent!</strong> Thank you for contacting us.
            </div>
            {{--<div id="contactFormError" class="formError alert alert-error sent-popup">
                <strong>Oops, An error has ocurred!</strong> See the marked fields above to fix the errors.
            </div>--}}
        </div>
    </form>
