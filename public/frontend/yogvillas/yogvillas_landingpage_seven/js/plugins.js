...
$(document).ready(function(){
	...
	/* googleMaps Footer Map */
		...
		var latlng = new google.maps.LatLng(28.41414,77.06533); <!-- (Fist Value Longitude, Second Value Latitude), can obtain YOUR coordenates here!: http://universimmedia.pagesperso-orange.fr/geo/loc.htm -->
		var styles = [
			{
		...
		var point0 = new google.maps.LatLng(28.41414,77.06533); <!-- (Fist Value Longitude, Second Value Latitude), can obtain YOUR coordenates here!: http://universimmedia.pagesperso-orange.fr/geo/loc.htm -->
		...
		google.maps.event.addListener(marker0,'click',
		 ...
		 {content: '<strong>Tranquille Living Spaces Pvt. Ltd.</strong><br/>#401, Tower-C, Nirvana Courtyard,<br/>Nirvana Country, Sector-50,<br/>Gurgaon, Haryana.<br/>Phone - <strong>+91 124 4203700, +91 124 4209301</strong><br/>Email - <strong>sales@tranquille.in</strong> '});
