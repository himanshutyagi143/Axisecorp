...
class ContactController extends BaseController
{
    ...
    public function contact(Request $request){
        ...
        if ($validator->fails()) {
            ...
            $notsent_otp = ['lakecityplazaemailer','gunjan_emailer','yogvillasPromo19May2021','location_advantage_reminder'];
            if(in_array($request->page_reference,$notsent_otp) == false ){
                ...
                return response(['status'=>1,'msg'=>'Form submitted successfull!']);
            }
    ...
    public function sendDatatoSellDo($data)
    {
        ...
        $result = curl_exec($ch);
        curl_close($ch);
        $emailer_campaing = ['lakecityplazaemailer','gunjan_emailer','location_advantage_reminder'];
